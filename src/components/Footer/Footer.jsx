...
export default function Footer() {
    ...
    return (
        <footer className="bg-slate-500 border-y">
                ...
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            ...
                            <span className="text-xl font-semibold text-gray-900">Ravan Mann</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold bg-slate-600 rounded-lg p-2 text-gray-900 uppercase">Follow us</h2>
                            <ul className="text-gray-500 font-medium text-white">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/Ravan-mann"
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold bg-slate-600 rounded-lg p-2 text-gray-900 uppercase">Legal</h2>
                            <ul className="text-gray-500 font-medium text-white">
                                <li className="mb-4">
                ...
                <div className="sm:flex sm:items-center  sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0 text-white">
                        ...
                        <Link to="#" className="text-white hover:text-gray-900">
                            ...
                            <span className="sr-only hover">Discord community</span>
                        </Link>
                        <Link to="#" className="text-white hover:text-gray-900">
                            <svg
                                className="w-4 h-4"
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-gray-500 hover:text-gray-900 bg-white rounded-full "
                        >
                            <svg
                                className="w-4 h-4 "
                                aria-hidden="true"
                        ...
                        <Link to="#" className="text-gray-500 hover:text-gray-900 bg-white rounded-full ">
                            <svg
